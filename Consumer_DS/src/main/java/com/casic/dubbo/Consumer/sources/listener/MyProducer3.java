...
public class MyProducer3 {
	...
	public static void main(String[] args) throws ParseException, InterruptedException {
		...
		String context0 ="{\"orgId\":\"8421746\",\"v\":\"1000\",\"createTime\":\"?\",\"t\":\"?\",\"iot\":\"10000049610850\",\"equipment\":\"10000050940000\",\"k\":\"state\"}";
       ...
       /* while (true) {
            ...
            Thread e=new Thread(new TaskProducer3(topic, properties, list));
            e.start();
        /*}*/
...
class TaskProducer3 implements Runnable{
	//KafkaProducer producer;
	Properties properties;
	List <String> context;
	String topic;
	public TaskProducer3(String topic,Properties properties,List context) {
		this.topic=topic;
	...
	public void run() {
		...
		while (true) {
			...
			String a=	context.get(i%10).replaceAll("\\?", System.currentTimeMillis()+"");
